  ...
  handleRating(e: any) {
    switch (e.target.id) {
      case `star-${this.props.counter}-1`: {
        ...
        promise.then(() => {
          setObject(this.props.name, {
            stars: this.state.stars['oneStar'] ? 1 : null,
            isFavourite: this.state.isFavourite,
          })
        })
      ...
      case `star-${this.props.counter}-2`: {
        ...
        promise.then(() => {
          setObject(this.props.name, {
            stars: this.state.stars['twoStars'] ? 2 : null,
            isFavourite: this.state.isFavourite,
          })
        })
      ...
      case `star-${this.props.counter}-3`: {
        ...
        promise.then(() => {
          setObject(this.props.name, {
            stars: this.state.stars['threeStars'] ? 3 : null,
            isFavourite: this.state.isFavourite,
          })
        })
      ...
      case `star-${this.props.counter}-4`: {
        ...
        promise.then(() => {
          setObject(this.props.name, {
            stars: this.state.stars['fourStars'] ? 4 : null,
            isFavourite: this.state.isFavourite,
          })
        })
      ...
      case `star-${this.props.counter}-5`: {
        ...
        promise.then(() => {
          setObject(this.props.name, {
            stars: this.state.stars['fiveStars'] ? 5 : null,
            isFavourite: this.state.isFavourite,
          })
        })
    ...
    return (
      <div className="dish-actions__container">
        <div className="rating-area">
          <input
            type="radio"
            id={`star-${this.props.counter}-5`}
            onChange={(e: any) => this.handleRating(e)}
            checked={fiveStars}
          />
