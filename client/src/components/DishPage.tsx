...
class DishPage extends Component<MyProps, MyState> {
  ...
  UNSAFE_componentWillMount() {
    this.setState({
      ...
      dynamicImage: {
        backgroundImage:
          'linear-gradient(45deg, rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.8)), url(' +
          ...
          <div className="dish-container">
            <div className="img-container">
              ...
              <div className="short-description">
                <span className="name">{this.state.dish.name}</span>
                ...
                >
                  <FormattedMessage
                    id="dish.showRecipe.button"
                    defaultMessage="Show Recipe"
                  />
                </div>
              </div>
            </div>
